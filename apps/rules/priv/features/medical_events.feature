...
Feature: Medical events
    ...
    @rule_3 @read @encounter @observation @condition @allergy_intolerance @immunization
    ...
    @rule_5 @read @episode @encounter @observation @condition @allergy_intolerance @immunization
